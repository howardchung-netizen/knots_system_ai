...
const PDFCompare = props => {
  ...
  const { refetch } = useQuery(GET_PDF_UPLOADS, {
  ...
  return (
    <div className="PDFCompare">
      ...
      <Backdrop className={classes.backdrop} open={pdfSourceCreateLoading || pdfUploadDeleteLoading || pdfSourceSaveDataLoading}>
...
export default withRouter(PDFCompare);
