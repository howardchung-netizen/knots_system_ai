...
declare module 'pdfkit-next/js/data' {
...
declare module 'pdfkit-next/js/gradient' {
  var gradient: {
...
declare module 'pdfkit-next/js/page' {
...
declare module 'pdfkit-next/js/reference' {
  var PDFKitReference: PDFKit.PDFKitReference;

  export = PDFKitReference;
}

declare module 'pdfkit-next/js/mixins/annotations' {
  var PDFKitAnnotation: PDFKit.Mixins.PDFAnnotation;
  export = PDFKitAnnotation;
}

declare module 'pdfkit-next/js/mixins/color' {
  var PDFKitColor: PDFKit.Mixins.PDFColor;
  export = PDFKitColor;
}

declare module 'pdfkit-next/js/mixins/fonts' {
  var PDFKitFont: PDFKit.Mixins.PDFFont;
  export = PDFKitFont;
}

declare module 'pdfkit-next/js/mixins/images' {
  var PDFKitImage: PDFKit.Mixins.PDFImage;
  export = PDFKitImage;
}

declare module 'pdfkit-next/js/mixins/text' {
  var PDFKitText: PDFKit.Mixins.PDFText;
  export = PDFKitText;
}

declare module 'pdfkit-next/js/mixins/vector' {
