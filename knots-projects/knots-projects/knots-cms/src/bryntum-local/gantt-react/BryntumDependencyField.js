...
var BryntumDependencyField = /*#__PURE__*/function (_Component) {
  _inherits(BryntumDependencyField, _Component);

  var _super = _createSuper(BryntumDependencyField);

  function BryntumDependencyField() {
    var _this;

    _classCallCheck(this, BryntumDependencyField);
  ...
  _createClass(BryntumDependencyField, [{
  ...
  return BryntumDependencyField;
}(Component);

BryntumDependencyField.instanceClass = DependencyField;
export { BryntumDependencyField as default };