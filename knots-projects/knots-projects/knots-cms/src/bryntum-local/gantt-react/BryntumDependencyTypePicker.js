...
var BryntumDependencyTypePicker = /*#__PURE__*/function (_Component) {
  _inherits(BryntumDependencyTypePicker, _Component);

  var _super = _createSuper(BryntumDependencyTypePicker);

  function BryntumDependencyTypePicker() {
    var _this;

    _classCallCheck(this, BryntumDependencyTypePicker);
  ...
  _createClass(BryntumDependencyTypePicker, [{
  ...
  return BryntumDependencyTypePicker;
}(Component);

BryntumDependencyTypePicker.instanceClass = DependencyTypePicker;
export { BryntumDependencyTypePicker as default };