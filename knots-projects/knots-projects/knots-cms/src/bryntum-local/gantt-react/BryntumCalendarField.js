...
var BryntumCalendarField = /*#__PURE__*/function (_Component) {
  _inherits(BryntumCalendarField, _Component);

  var _super = _createSuper(BryntumCalendarField);

  function BryntumCalendarField() {
    var _this;

    _classCallCheck(this, BryntumCalendarField);
  ...
  _createClass(BryntumCalendarField, [{
  ...
  return BryntumCalendarField;
}(Component);

BryntumCalendarField.instanceClass = CalendarField;
export { BryntumCalendarField as default };