...
var BryntumTextAreaPickerField = /*#__PURE__*/function (_Component) {
  _inherits(BryntumTextAreaPickerField, _Component);

  var _super = _createSuper(BryntumTextAreaPickerField);

  function BryntumTextAreaPickerField() {
    var _this;

    _classCallCheck(this, BryntumTextAreaPickerField);
  ...
  _createClass(BryntumTextAreaPickerField, [{
  ...
  return BryntumTextAreaPickerField;
}(Component);

BryntumTextAreaPickerField.instanceClass = TextAreaPickerField;
export { BryntumTextAreaPickerField as default };