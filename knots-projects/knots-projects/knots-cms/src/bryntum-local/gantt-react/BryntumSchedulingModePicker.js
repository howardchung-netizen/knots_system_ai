...
var BryntumSchedulingModePicker = /*#__PURE__*/function (_Component) {
  _inherits(BryntumSchedulingModePicker, _Component);

  var _super = _createSuper(BryntumSchedulingModePicker);

  function BryntumSchedulingModePicker() {
    var _this;

    _classCallCheck(this, BryntumSchedulingModePicker);
  ...
  _createClass(BryntumSchedulingModePicker, [{
  ...
  return BryntumSchedulingModePicker;
}(Component);

BryntumSchedulingModePicker.instanceClass = SchedulingModePicker;
export { BryntumSchedulingModePicker as default };