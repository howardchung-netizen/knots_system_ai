...
/**
 * React wrapper for Bryntum CycleResolutionPopup
 */
import React, { Component } from 'react';
import WrapperHelper from './WrapperHelper.js';
import { CycleResolutionPopup } from '@bryntum/gantt';

var BryntumCycleResolutionPopup = /*#__PURE__*/function (_Component) {
  _inherits(BryntumCycleResolutionPopup, _Component);

  var _super = _createSuper(BryntumCycleResolutionPopup);

  function BryntumCycleResolutionPopup() {
    var _this;

    _classCallCheck(this, BryntumCycleResolutionPopup);
  ...
  _createClass(BryntumCycleResolutionPopup, [{
  ...
  return BryntumCycleResolutionPopup;
}(Component);

BryntumCycleResolutionPopup.instanceClass = CycleResolutionPopup;
export { BryntumCycleResolutionPopup as default };