...
var BryntumPasswordField = /*#__PURE__*/function (_Component) {
  _inherits(BryntumPasswordField, _Component);

  var _super = _createSuper(BryntumPasswordField);

  function BryntumPasswordField() {
    var _this;

    _classCallCheck(this, BryntumPasswordField);
  ...
  _createClass(BryntumPasswordField, [{
  ...
  return BryntumPasswordField;
}(Component);

BryntumPasswordField.instanceClass = PasswordField;
export { BryntumPasswordField as default };