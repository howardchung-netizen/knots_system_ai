...
var BryntumUndoRedo = /*#__PURE__*/function (_Component) {
  ...
  function BryntumUndoRedo() {
    ...
    _this.configNames = ['adopt', 'align', 'anchor', 'appendTo', 'ariaDescription', 'ariaLabel', 'bubbleEvents', 'callOnFunctions', 'centered', 'cls', 'color', 'config', 'constrainTo', 'contentElementCls', 'defaultBindProperty', 'defaultFocus', 'defaults', 'dock', 'draggable', 'floating', 'hideAnimation', 'hideWhenEmpty', 'htmlCls', 'insertBefore', 'insertFirst', 'itemCls', 'lazyItems', 'listeners', 'localeClass', 'localizableProperties', 'maskDefaults', 'masked', 'monitorResize', 'namedItems', 'owner', 'positioned', 'preventTooltipOnTouch', 'project', 'ripple', 'rootElement', 'scheduler', 'scrollAction', 'showAnimation', 'showTooltipWhenDisabled', 'showZeroActionBadge', 'tab', 'tag', 'text', 'textAlign', 'textContent', 'title', 'ui', 'weight'];
