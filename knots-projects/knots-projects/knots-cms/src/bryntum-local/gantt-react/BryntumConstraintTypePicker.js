...
var BryntumConstraintTypePicker = /*#__PURE__*/function (_Component) {
  _inherits(BryntumConstraintTypePicker, _Component);

  var _super = _createSuper(BryntumConstraintTypePicker);

  function BryntumConstraintTypePicker() {
    var _this;

    _classCallCheck(this, BryntumConstraintTypePicker);
  ...
  _createClass(BryntumConstraintTypePicker, [{
  ...
  return BryntumConstraintTypePicker;
}(Component);

BryntumConstraintTypePicker.instanceClass = ConstraintTypePicker;
export { BryntumConstraintTypePicker as default };