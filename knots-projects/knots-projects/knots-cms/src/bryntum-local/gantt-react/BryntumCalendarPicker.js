...
var BryntumCalendarPicker = /*#__PURE__*/function (_Component) {
  _inherits(BryntumCalendarPicker, _Component);

  var _super = _createSuper(BryntumCalendarPicker);

  function BryntumCalendarPicker() {
    var _this;

    _classCallCheck(this, BryntumCalendarPicker);
  ...
  _createClass(BryntumCalendarPicker, [{
  ...
  return BryntumCalendarPicker;
}(Component);

BryntumCalendarPicker.instanceClass = CalendarPicker;
export { BryntumCalendarPicker as default };