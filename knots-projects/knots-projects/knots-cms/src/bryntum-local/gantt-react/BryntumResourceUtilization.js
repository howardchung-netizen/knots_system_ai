...
var BryntumResourceUtilization = /*#__PURE__*/function (_Component) {
  _inherits(BryntumResourceUtilization, _Component);

  var _super = _createSuper(BryntumResourceUtilization);

  function BryntumResourceUtilization() {
    var _this;

    _classCallCheck(this, BryntumResourceUtilization);
  ...
  _createClass(BryntumResourceUtilization, [{
