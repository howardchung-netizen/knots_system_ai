...
var BryntumModelCombo = /*#__PURE__*/function (_Component) {
  _inherits(BryntumModelCombo, _Component);

  var _super = _createSuper(BryntumModelCombo);

  function BryntumModelCombo() {
    var _this;

    _classCallCheck(this, BryntumModelCombo);
  ...
  _createClass(BryntumModelCombo, [{
  ...
  return BryntumModelCombo;
}(Component);

BryntumModelCombo.instanceClass = ModelCombo;
export { BryntumModelCombo as default };