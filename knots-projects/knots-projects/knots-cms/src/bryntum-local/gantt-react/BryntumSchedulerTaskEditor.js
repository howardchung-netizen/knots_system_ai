...
/**
 * React wrapper for Bryntum SchedulerTaskEditor
 */
import React, { Component } from 'react';
import WrapperHelper from './WrapperHelper.js';
import { SchedulerTaskEditor } from '@bryntum/gantt';

var BryntumSchedulerTaskEditor = /*#__PURE__*/function (_Component) {
  _inherits(BryntumSchedulerTaskEditor, _Component);

  var _super = _createSuper(BryntumSchedulerTaskEditor);

  function BryntumSchedulerTaskEditor() {
    var _this;

    _classCallCheck(this, BryntumSchedulerTaskEditor);
  ...
  _createClass(BryntumSchedulerTaskEditor, [{
  ...
  return BryntumSchedulerTaskEditor;
}(Component);

BryntumSchedulerTaskEditor.instanceClass = SchedulerTaskEditor;
export { BryntumSchedulerTaskEditor as default };