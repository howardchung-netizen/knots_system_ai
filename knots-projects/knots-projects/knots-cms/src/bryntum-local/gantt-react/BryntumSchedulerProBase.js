...
var BryntumSchedulerProBase = /*#__PURE__*/function (_Component) {
  _inherits(BryntumSchedulerProBase, _Component);

  var _super = _createSuper(BryntumSchedulerProBase);

  function BryntumSchedulerProBase() {
    var _this;

    _classCallCheck(this, BryntumSchedulerProBase);
  ...
  _createClass(BryntumSchedulerProBase, [{
