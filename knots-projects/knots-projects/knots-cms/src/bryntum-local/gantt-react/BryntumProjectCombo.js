...
var BryntumProjectCombo = /*#__PURE__*/function (_Component) {
  _inherits(BryntumProjectCombo, _Component);

  var _super = _createSuper(BryntumProjectCombo);

  function BryntumProjectCombo() {
    var _this;

    _classCallCheck(this, BryntumProjectCombo);
  ...
  _createClass(BryntumProjectCombo, [{
  ...
  return BryntumProjectCombo;
}(Component);

BryntumProjectCombo.instanceClass = ProjectCombo;
export { BryntumProjectCombo as default };