...
/**
 * React wrapper for Bryntum GanttTaskEditor
 */
import React, { Component } from 'react';
import WrapperHelper from './WrapperHelper.js';
import { GanttTaskEditor } from '@bryntum/gantt';

var BryntumGanttTaskEditor = /*#__PURE__*/function (_Component) {
  _inherits(BryntumGanttTaskEditor, _Component);

  var _super = _createSuper(BryntumGanttTaskEditor);

  function BryntumGanttTaskEditor() {
    var _this;

    _classCallCheck(this, BryntumGanttTaskEditor);
  ...
  _createClass(BryntumGanttTaskEditor, [{
  ...
  return BryntumGanttTaskEditor;
}(Component);

BryntumGanttTaskEditor.instanceClass = GanttTaskEditor;
export { BryntumGanttTaskEditor as default };