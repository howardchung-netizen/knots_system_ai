...
var BryntumRadio = /*#__PURE__*/function (_Component) {
  _inherits(BryntumRadio, _Component);

  var _super = _createSuper(BryntumRadio);

  function BryntumRadio() {
    var _this;

    _classCallCheck(this, BryntumRadio);
...
export { BryntumRadio as default };