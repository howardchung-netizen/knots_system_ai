...
/**
 * React wrapper for Bryntum SchedulingIssueResolutionPopup
 */
import React, { Component } from 'react';
import WrapperHelper from './WrapperHelper.js';
import { SchedulingIssueResolutionPopup } from '@bryntum/gantt';

var BryntumSchedulingIssueResolutionPopup = /*#__PURE__*/function (_Component) {
  _inherits(BryntumSchedulingIssueResolutionPopup, _Component);

  var _super = _createSuper(BryntumSchedulingIssueResolutionPopup);

  function BryntumSchedulingIssueResolutionPopup() {
    var _this;

    _classCallCheck(this, BryntumSchedulingIssueResolutionPopup);
  ...
  _createClass(BryntumSchedulingIssueResolutionPopup, [{
  ...
  return BryntumSchedulingIssueResolutionPopup;
}(Component);

BryntumSchedulingIssueResolutionPopup.instanceClass = SchedulingIssueResolutionPopup;
export { BryntumSchedulingIssueResolutionPopup as default };