...
var BryntumResourceHistogram = /*#__PURE__*/function (_Component) {
  _inherits(BryntumResourceHistogram, _Component);

  var _super = _createSuper(BryntumResourceHistogram);

  function BryntumResourceHistogram() {
    var _this;

    _classCallCheck(this, BryntumResourceHistogram);
  ...
  _createClass(BryntumResourceHistogram, [{
