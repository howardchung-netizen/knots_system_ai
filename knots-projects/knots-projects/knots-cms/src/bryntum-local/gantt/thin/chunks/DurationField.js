 ...
 *
 */
import { TextField, Duration, ObjectHelper, DateHelper } from './Editor.js';
...
class DurationField extends TextField {
  ...
  set value(value) {
    ...
    if (me._magnitude !== newMagnitude || me._unit !== newUnit) {
      me._magnitude = newMagnitude; // Once we have unit, do not clear it if setting clearing value
