...
export default class HorizontalRendering extends Base.mixin(BaseRendering, AttachToProjectMixin) {
    ...
    setupRenderData(timeSpan, rowRecord) {
        const
            ...
            useEventBuffer                 = scheduler.features.eventBuffer?.enabled && me.isProHorizontalRendering &&
            ...
            { startMS, endMS, durationMS } = me.calculateMS(timeSpan, startDateField, endDateField),
    ...
    fillTimeSpanHorizontalPosition(renderData) {
        const { startMS, endMS, durationMS } = renderData;
