...
export default class Store extends Base.mixin(
    ...
    set data(data) {
        ...
        if (this.transformFlatData && data?.length > 0 && !Object.isExtensible(data[0])) {
            // Avoid cloning object again in Model
            this.useRawData = this.useRawData || { disableDuplicateIdCheck : false, disableDefaultValue : false, disableTypeConversion : false };
