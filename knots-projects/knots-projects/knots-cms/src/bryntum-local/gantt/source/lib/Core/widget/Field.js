...
/**
 * Base class for {@link Core.widget.TextField TextField} and {@link Core.widget.NumberField NumberField}. Not to be
 * used directly.
 *
 * Most subclasses can be used as editors for the {@link Grid.column.Column Column}. The most popular are:
 ...
 * @extends Core/widget/Widget
 */
Field.Trigger = class FieldTrigger extends Widget.mixin(KeyMap) {
    static get $name() {
        return 'FieldTrigger';
    }
