...
import CalendarCompatMixin from '../../Scheduler/model/mixin/CalendarCompatMixin.js';
...
export default class EventModel extends SchedulerProEvent.derive(TimeSpan).mixin(
    ...
    set startDate(startDate) {
        ...
        if (me.batching) {
            ...
            if (me.preamble) {
                me.set('wrapStartDate', null, true);
                me.set('wrapEndDate', null, true);
            }
        }
    }
    ...
    get wrapStartDate() {
        const
            ...
            wrapStartDate           = me.get('wrapStartDate');
        ...
        if (wrapStartDate) {
            ...
            if (preamble) {
                ...
                me.set('wrapStartDate', result, true);
            }
            else {
                result = startDate;
            }
    ...
    get wrapEndDate() {
        const
            ...
            wrapEndDate            = me.get('wrapEndDate');
        ...
        if (wrapEndDate) {
            ...
            if (postamble) {
                ...
                me.set('wrapEndDate', result, true);
            }
            else {
                result = endDate;
            }
    ...
    set wrapEndDate(value) {
        this.set('wrapEndDate', value);
    }

    get preamble() {
        return this.get('preamble');
    }

    set preamble(value) {
        this.set('preamble', value);

        this.wrapStartDate = this.updateWrapDate(this.startDate, value, false);
    }

    get postamble() {
        return this.get('postamble');
    }

    set postamble(value) {
        this.set('postamble', value);

        this.wrapEndDate = this.updateWrapDate(this.endDate, value);
    }
