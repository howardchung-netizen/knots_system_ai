...
export default class ActionColumn extends Column {
     ...
     * @private
     */
    internalRenderer({ column, record, callExternalRenderer = true }) {
    ...
    updateAutoWidth() {
        ...
        const
            actionsHtml = DomHelper.createElement(me.internalRenderer({ column : { actions }, callExternalRenderer : false })).outerHTML;
