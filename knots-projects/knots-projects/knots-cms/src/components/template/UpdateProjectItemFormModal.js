...
import { QUOTATION_TEMPLATE_UPDATE_ITEM, QUOTATION_UPDATE_ITEM } from '../../apollo/mutations';
...
export default function ({ open, onCloseClick, onCompleted, ...props }) {
  ...
  const [formDataUpdateMutate, updateStatus] = useMutation(QUOTATION_TEMPLATE_UPDATE_ITEM);
