...
export default class GanttToolbar extends Toolbar {
  ...
  onLanguageClick() {
    ...
    if (gantt.features.labels.initialConfig.left.field === 'name') {
      window.location.href = window.location.origin + '/cms/gantt_chart_en/project/' + window.location.pathname.split('/').pop();
    } else {
      window.location.href = window.location.origin + '/cms/gantt_chart/project/' + window.location.pathname.split('/').pop();
    }
  }
